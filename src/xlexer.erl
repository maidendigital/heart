-file("/usr/local/Cellar/erlang/21.0.9/lib/erlang/lib/parsetools-2.1.7/include/leexinc.hrl", 0).
...
to_atom(Chars) ->
  list_to_atom(Chars).
-file("/usr/local/Cellar/erlang/21.0.9/lib/erlang/lib/parsetools-2.1.7/include/leexinc.hrl", 14).
...
yystate(15, [10|Ics], Line, Tlen, _, _) ->
    yystate(15, Ics, Line+1, Tlen+1, 9, Tlen);
...
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 11, C =< 40 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
yystate(14, [C|Ics], Line, Tlen, Action, Alen) when C >= 42 ->
    yystate(14, Ics, Line, Tlen+1, Action, Alen);
...
yystate(13, [C|Ics], Line, Tlen, Action, Alen) when C >= 60, C =< 63 ->
    yystate(12, Ics, Line, Tlen+1, Action, Alen);
...
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 48, C =< 57 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
yystate(12, [C|Ics], Line, Tlen, _, _) when C >= 60, C =< 63 ->
    yystate(12, Ics, Line, Tlen+1, 4, Tlen);
...
yystate(8, [102|Ics], Line, Tlen, Action, Alen) ->
